...
В блоке hero справа используется **абстрактная композиция** (градиенты, свет, grain) без фотографии. Файл `images/hero-lifestyle.png` в репозитории можно удалить или оставить для других целей — в вёрстке не подключается.
