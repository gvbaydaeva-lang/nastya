...
В блоке hero справа используется фото `images/hero-scene.png` (атмосфера, мягкое растворение в фон через градиенты). Исходный файл можно хранить под любым именем в папке проекта и при замене снимка обновить `hero-scene.png`.
